Отличное замечание! Функция `pd.read_xml` была добавлена в Pandas версии 1.3.0 и значительно упростила работу с XML. Я полностью переработал секцию про XML, чтобы показать и новый, и старый методы.
...
**Способ 1: Использование `pd.read_xml` (рекомендуемый, Pandas >= 1.3)**
...
**Способ 2: Ручной парсинг с `lxml` (для старых версий Pandas или сложных случаев)**
